        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MediaRequestID = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaVotes", x => x.ID);
                    table.ForeignKey(
                        name: "FK_MediaVotes_MediaRequests_MediaRequestID",
                        column: x => x.MediaRequestID,
                        principalTable: "MediaRequests",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MediaVotes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaVotes_MediaRequestID",
                table: "MediaVotes",
                column: "MediaRequestID");

            migrationBuilder.CreateIndex(
                name: "IX_MediaVotes_UserId",
                table: "MediaVotes",
                column: "UserId");
        }
